...
export const fetchUserByToken = createAsyncThunk(
   ...
   async () => {
      ...
      const res: {id: string; username: string; avatar: string; role: boolean} =
         await new Promise((resovle, reject) => {
            setTimeout(() => {
               const curUser: {
                  ...
                  username: 'khangpn',
                  avatar:
                     'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuEvKHSodSNlROQYDU-lUWHH1MI8RmCbFl2xpisFnQ&s',
                  role: false,
               };
