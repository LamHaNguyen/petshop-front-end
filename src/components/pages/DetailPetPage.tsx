                     ...
                     <div className='w-full md:w-[40%] '>
                        ...
                        <ul className='mt-[22px] mb-10 flex flex-col gap-4'>
                           <Li
                              icon={faCat}
                              title='Type'
                              content={detailDataPets.type}
                           />
                           <Li
                              icon={faPalette}
                              title='Colors'
                              content={detailDataPets.color}
                           />
                           <Li
                              icon={faVenus}
                              title='Genther'
                              content={detailDataPets.sex}
                           />
                           <Li
                              icon={faSitemap}
                              title='Size'
                              content={detailDataPets.size}
                           />
                           <Li
                              icon={faBomb}
                              title='Sterilization'
                              content={detailDataPets.sterilization}
                           />
                           <Li
                              icon={faSyringe}
                              title='Vaccination'
                              content={detailDataPets.vaccination}
                           />
                           <li className='text-lg flex items-center gap-2 '>
                              ...
                              <p className='truncate text-fill-heart'>
                                 ...
                                 <b>{detailDataPets.fosterDate}</b> days
                              </p>
                           </li>
                        </ul>
