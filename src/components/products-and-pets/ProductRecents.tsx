...
export default function ProductRencent({
   data,
   title,
   fontSizeTitle,
      ...
      >
         <div
            ...
            className={classNames(
               'scroll grid grid-flow-col auto-cols-[60%] md:auto-cols-[30%] lg:auto-cols-5item gap-[10px] pb-4 select-none transition-all ease-linear',
               {
