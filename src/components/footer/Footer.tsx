      ...
      <footer className='bg-slate-950 text-sm overflow-hidden'>
         <div className='w-[1280px] m-auto'>
            <div className='p-0 grid grid-cols-4'>
               <Grid item xs={12} lg={5} className='col-span-2'>
                  <p className='text-cyan-600 font-bold text-3xl pt-6'>
                     Pet
                     <span className='text-lime-600  font-bold text-3xl'>
                        Foster
                     </span>{' '}
                  </p>
                  <Grid item lg={2}>
                  ...
                  <p className='text-slate-50 text-justify pt-4'>
                     ...
                     Repellendus quam dolorem voluptate adipisci culpa
                     architecto eum aut. Non fuga cumque consequatur,
                     repellendus dolore modi voluptates architecto in eos
                     aliquam expedita.
                  </p>
               </Grid>
               <Grid item xs={12} lg={3}>
                  <div className=''>
                     <p className='text-lime-600 font-bold text-3xl pl-6 pt-6'>
                        About Us
                     </p>
                     <Grid item lg={4}>
                        ...
                        <li>
                           <p className='text-slate-50'>
                              ...
                              <FontAwesomeIcon
                                 ...
                                 className='pr-2'
                              />{' '}
                              288, Nguyen Van Linh, An Khanh, Ninh Kieu, Can Tho
                           </p>
                        </li>
                        <li className='pt-6'>
                           <a href='/login' className='text-slate-50'>
            ...
            <Grid item lg={12}>
               ...
               <p className='text-slate-50 text-base pt-6 flex justify-center my-5'>
                  © 2023 PetFoster . All Rights Reserved.
               </p>
            </Grid>
         </div>
      </footer>
